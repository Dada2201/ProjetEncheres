...
class RetraitDAOJdbcImpl implements RetraitDAO {
	...
	private Retrait retraitBuilder(ResultSet rs) throws SQLException, NumberFormatException, BusinessException {
		Retrait retrait = new Retrait(ArticleDAOJdbcImpl.articleBuilder(rs), rs.getString("retraits.rue"),
				rs.getString("retraits.code_postal"), rs.getString("retraits.ville"));
		return retrait;
	}
